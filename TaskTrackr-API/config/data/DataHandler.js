...
module.exports = class DataHandler {
    ...
    /**
     * Verifies a user against our user list
     * @param email
     * @param password
     * @returns {Promise<User>} The user object, if details are correct - null otherwise
     */
    ...
    /**
     * Retrieves the email count for a given email address
     * @param {string} email - The email address to check
     * @returns {Promise<number>} The count of records associated with the email
     */
    ...
    /**
     * Retrieves a task by its GUID, or undefined if no task exists
     * @param {string} guid - The GUID of the task to retrieve
     * @returns {Promise<task>} The task associated with the provided GUID
     */
